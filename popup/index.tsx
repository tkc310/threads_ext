...
import { CHROME_MESSAGES, DEFAULT_DELAY } from "~constants";
...
const handleUnfollow = (delay: number) => {
  chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    ...
    if (currentTabId) {
      chrome.tabs.sendMessage(
        currentTabId,
        { type: CHROME_MESSAGES.EXECUTE, delay: delay || DEFAULT_DELAY },
        (response) => {
...
const Logo = () => (
  <svg aria-label="Threads" fill="#fff" height="100%" role="img" viewBox="0 0 192 192" width="100%" xmlns="http://www.w3.org/2000/svg">
